...
3. Fixez le spéléothème sous un bloc plein, pointe vers le bas.
4. Posez une source de lave directement au-dessus de ce bloc.
5. Entourez la lave de blocs solides pour éviter tout écoulement.
6. Attendez que le chaudron se remplisse.
7. Récupérez la lave avec un seau.
...
Vérifiez que la lave est une source, que le spéléothème pointe vers le chaudron et qu'un seul bloc plein les sépare.

### La lave s'écoule dans la pièce

Le réservoir n'est pas fermé. Utilisez uniquement des blocs pleins autour de chaque source avant de la poser.

### La production semble très lente
