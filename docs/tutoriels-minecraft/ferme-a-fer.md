...
- Un zombie ou une autre source de panique selon le modèle
- Un wagonnet, un bateau ou des blocs pour sécuriser le zombie
...
3. Installez et sécurisez les villageois.
4. Ajoutez le zombie sans lui permettre de les toucher.
5. Créez une plateforme d'apparition autour ou au-dessus du module.
6. Utilisez de l'eau pour pousser les golems vers une ouverture.
7. Placez une lame de lave au-dessus des entonnoirs.
8. Bloquez les autres surfaces proches où un golem pourrait apparaître.
...
Vérifiez que les villageois ont pu dormir, qu'ils voient la source de danger et qu'aucun golem n'est bloqué à proximité.

### Les golems apparaissent hors de la ferme

Rendez les surfaces voisines incompatibles avec leur apparition ou déplacez le module plus loin du sol.

### Les villageois ne dorment jamais
