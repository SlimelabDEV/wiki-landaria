...
- Une source régulière de végétaux
...
3. Posez le composteur sur l'entonnoir.
4. Placez un second entonnoir au-dessus du composteur.
5. Ajoutez le coffre d'entrée au-dessus.
6. Déposez les végétaux dans le coffre supérieur.
...
Vérifiez l'orientation de l'entonnoir et assurez-vous que les objets sont compostables.

### Le composteur est plein, mais rien ne sort

L'entonnoir inférieur doit pointer vers le coffre et ne pas être alimenté par un signal de redstone.
