...
- Plusieurs lits
- Un composteur
- Un champ de carottes ou de pommes de terre
- De l'eau et de la terre
- Des trappes ou des barrières
- Des rails, wagonnets ou bateaux pour le transport
- Des blocs et des sources de lumière
...
3. Installez les deux villageois.
4. Donnez-leur suffisamment de nourriture pour démarrer.
5. Ajoutez des lits accessibles avec de l'espace libre au-dessus.
6. Construisez une sortie que les bébés peuvent emprunter sans laisser passer les adultes.
7. Éloignez les nouveaux villageois des lits afin de libérer la capacité du module.
...
Aucun lit valide n'est disponible. Vérifiez le nombre de lits, l'espace au-dessus et leur accessibilité.

### Les villageois ne ramassent pas la nourriture

Leur inventaire peut être plein ou les règles du monde peuvent empêcher le ramassage par les créatures. Sur certains serveurs, ce comportement est limité.

### Le fermier ne travaille pas
