...
- Un bloc de glace bleue
- Des blocs non inflammables
- Un piston pour une version semi-automatique
- Un levier, un bouton ou une horloge lente
- Un système de collecte facultatif
...
3. Fermez les côtés avec des blocs résistants.
4. Faites arriver la lave dans l'espace vide.
5. Le basalte se forme immédiatement.
6. Cassez le bloc pour laisser le suivant apparaître.
...
Réglez le circuit sur une vitesse raisonnable. Une horloge trop rapide active le piston inutilement et peut être désagréable sur un serveur.
...
Contrôlez la terre des âmes et la glace bleue. Le basalte exige cette combinaison précise autour du bloc de génération.

### La lave devient de l'obsidienne

De l'eau touche probablement la source. Le générateur de basalte n'utilise aucune eau.
