...
:::danger Attention
Certains skills imposent l'utilisation d'items Minecraft, comme par exemple le skill Alchimie qui demandent l'utilisation d'alambics. Celles-ci sont limitées à 20 alambics en simultanée par joueur.
:::
...
:::important
Comme beaucoup de joueurs, il se peut que vous soyez un peu perdu au début, mais ne vous inquiétez pas, on s'y retrouve vite. Si besoin, le staff pourra vous guider sur le [**Discord**](https://discord.landaria.fr).
:::
